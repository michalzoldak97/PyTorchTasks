...
def train(epoch):
    ...
    loss_stats.to_csv('results/loss_net9_5.csv')
...
def train_optim(curr_res):
    ...
    if curr_res > max_result:
        ...
        save_net_state(state_to_save, "models/test9_5.pth.tar")
        max_result = curr_res
        num_before_imp = 0
    elif num_before_imp < 10:
        num_before_imp += 1
    else:
        load_net_state("models/test9_5.pth.tar")
        print("Loading net")
        test_failed += 1
    if test_failed > 9:
...
def train_net():
    ...
    for epoch in range(1, 1001):
        ...
        if epoch % check_every == 0:
            ...
            acc_stats.to_csv('results/stats_net9_5.csv')
